...
<body>
	<header class= "company-header">
		...
		<form class="flag-form">
			...
			<input type="hidden" name= "level_folder" value= "levels/level9">
...
<div class="flag-error"></div>
	...
	<main class= "challenge-content">
		...
		<div class="hint-section" data-level="9">
		...
		<p>Securissima Database Access, please enter Admin Credentials below.</p>
		</div>
