...
<body>
	...
	<p>A vulnerability that exposes important information via an error or within accesible logs.
	...
	Death (BSOD) errors on Windows or rpmdb errors on Linux/Unix enviroments. Others, like the one in this lab, give information
