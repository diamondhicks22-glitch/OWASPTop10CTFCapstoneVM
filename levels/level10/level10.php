...
<body>
	<header class= "company-header">
		...
		<form class="flag-form">
			...
			<input type="hidden" name= "level_folder" value= "levels/level10">
...
<div class="flag-error"></div>
	...
	<main class= "challenge-content">
		...
		<div class="hint-section" data-level="10">
		...
		<h2>Internal Service Registry</h2>
		<p>Search for a service by name</p>
		</div>
		
		<div class="fluff-text">
		<input type="text" class="flag-text-input modify" id="serviceSearch" placeholder="Enter service name/term">
